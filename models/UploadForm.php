...
class UploadForm extends \yii\base\Object {
	...
	public function init() {
		...
		if (! $this->savePath)
			$this->savePath = \Yii::$app->basePath . '/web/upload/image';
		...
		$this->urlPath = '/upload/image/' . $path . '/' . $this->baseName . '--' . $name . '.' . $this->extension;
	}
	 ...
	 * @return bool
	 */
	public static function CreateThumbnail($srcFile, $toFile = "", $toW = 800, $toH = 800) {
		if ($toFile == "")
			$toFile = $srcFile;
